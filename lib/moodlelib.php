...
function email_to_user($user, $from, $subject, $messagetext, $messagehtml = '', $attachment = '', $attachname = '',
    ...
    foreach ($temprecipients as $values) {
         $email_new = $values[0];
        $getArray_email_check_domain = explode("@",$email_new);
        
        //Check domain is eco.unrc.edu.ar
                          
        if ($getArray_email_check_domain[1] == "eco.unrc.edu.ar") { 
            //Change domain for alternative domain in office365.com
            $email_new = $getArray_email_check_domain[0] . "@ecounrceduar.onmicrosoft.com";
        }
        $mail->addAddress($email_new, $values[1]);
    }
    $mail->SMTPDebug = 2;
    $mail->SMPTAuth = true;
    $mail->SMTPSecure = 'none';
    $mail->Host = "167.250.5.51";
    $mail->Mailer = "smtp";
    $mail->Port = 9025;
    $mail->Username = "info@v.eco.unrc.edu.ar";
    $mail->Password = "Naranja04#";
