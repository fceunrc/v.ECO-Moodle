...
class core_course_renderer extends plugin_renderer_base {
    ...
    protected function course_overview_files(core_course_list_element $course): string {
        ...
        foreach ($course->get_course_overviewfiles() as $file) {
            ...
            if ($isimage) {
                ...
                $imagehtml = html_writer::empty_tag('img', ['src' => $url, 'alt' => '']);
                $linkhtml = html_writer::link($courseurl, $imagehtml);
    ...
    protected function coursecat_courses(coursecat_helper $chelper, $courses, $totalcount = null) {
        ...
        if ($chelper->get_show_courses() == self::COURSECAT_SHOW_COURSES_AUTO) {
            // Fuerza siempre la vista expandida, independientemente del número de cursos
            $chelper->set_show_courses(self::COURSECAT_SHOW_COURSES_EXPANDED);
        }
