...
$body = 'Hola ' . $user->firstname . ' ' . $user->lastname . '!<br><br>' .
'Has sido matriculado correctamente en el curso ' . '"' . $course->fullname . '"' .' del Ecosistema Virtual de la Facultad de Ciencias Económicas.<br><br>' .
'Ingresando a v.eco.unrc.edu.ar, pestaña "Mis cursos", puedes comenzar con las actividades.<br><br>' .
'¡Éxitos!';

// Send the email with both plain text and HTML versions of the message.
email_to_user($user, $USER, 'Notificación de matriculación', strip_tags($body), $body);
